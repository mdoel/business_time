...
describe Time do  
  ...
  context "" do
    it "should know what a weekend day is" do
      Time.weekday?(Time.parse("April 9, 2010 10:30am")).should be_true
      Time.weekday?(Time.parse("April 10, 2010 10:30am")).should_not be_true
      Time.weekday?(Time.parse("April 11, 2010 10:30am")).should_not be_true
      Time.weekday?(Time.parse("April 12, 2010 10:30am")).should be_true
    end

    it "should know a weekend day is not a workday" do
      Time.workday?(Time.parse("April 9, 2010 10:45 am")).should be_true
      Time.workday?(Time.parse("April 10, 2010 10:45 am")).should_not be_true
      Time.workday?(Time.parse("April 11, 2010 10:45 am")).should_not be_true
      Time.workday?(Time.parse("April 12, 2010 10:45 am")).should be_true
    end
    ...
    it "should know a holiday is not a workday" do
      ...
      Time.workday?(Time.parse("July 4th, 2010 1:15 pm")).should_not be_true
      Time.workday?(Time.parse("July 5th, 2010 2:37 pm")).should_not be_true
    end
