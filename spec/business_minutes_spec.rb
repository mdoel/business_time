...
describe BusinessTime::BusinessMinutes do
  ...
  context "with a standard Time object" do
    ...
    it "should move to the next 600 seconds (10 min) if we add 600 business seconds" do
      ...
      expected = Time.parse("04/09/2010 9:00")
    ...
    it "should take into account a weekend when adding an hour" do
      friday_afternoon = Time.parse("04/09/2010 17:38:23")
      monday_morning = 10.business_minutes.after(friday_afternoon)
      expected = Time.parse("04/09/2010 17:50")
      monday_morning.should == expected
    end
    ...
    it "should take into account a weekend when adding an hour" do
      ...
      monday_morning = 10.business_minutes.after(first)
      expected = Time.parse("04/09/2010 09:00")
      monday_morning.should == expected
    end

    it "should take into account a weekend when adding an hour" do
      first = Time.parse("04/09/2010 09:00:00")
      monday_morning = 10.business_minutes.after(first)
      expected = Time.parse("04/09/2010 09:10")
      monday_morning.should == expected
    end

    it "should take into account a weekend when adding an hour" do
      first = Time.parse("04/09/2010 08:55:00")
      monday_morning = 10.business_minutes.after(first)
      expected = Time.parse("04/09/2010 09:00")
      monday_morning.should == expected
    end
    ...
    it "shoudl take into account a holiday" do
      ...
      expected = Time.parse("July 9th 2010, 9:00 am")
      tuesday_morning.should == expected
    end


    it "should take into account a holiday" do
      BusinessTime::Config.holidays << Date.parse("July 5th, 2010")
      friday_afternoon = Time.parse("July 5th 2010, 08:55am")
      tuesday_morning = 10.business_minutes.after(friday_afternoon)
      expected = Time.parse("July 9th 2010, 9:00 am")
      tuesday_morning.should == expected
    end
    ...
    it "shoudl take into account a holiday" do
      BusinessTime::Config.holidays << Date.parse("July 5th, 2010")
      friday_afternoon = Time.parse("July 5th 2010, 09:10am")
      tuesday_morning = 10.business_minutes.after(friday_afternoon)
      expected = Time.parse("July 9th 2010, 9:00 am")
      tuesday_morning.should == expected
    end
    ...
    it "should jump to the next block if at the end of a block"  do
      monday_night = Time.parse("April 12th 2010, 17:50")
      later = 10.business_minutes.after(monday_night)
      expected = Time.parse("April 16th 2010, 09:00 am")
      later.should == expected
    end

    it "should jump to the next block if at the end of a block"  do
      monday_night = Time.parse("April 12th 2010, 17:45")
      later = 15.business_minutes.after(monday_night)
      expected = Time.parse("April 16th 2010, 09:00 am")
      later.should == expected
    end
    ...
    it "should roll forward to the next morning if aftern business hours" do
      ...
      tuesday_morning = Time.parse("Tue Apr 30, 09:00:00, 2010")
